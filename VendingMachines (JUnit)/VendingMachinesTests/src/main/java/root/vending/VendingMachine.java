...
public class VendingMachine
{
  ...
  public Response fillProducts() // ok
  {
  ...
  public Response fillCoins(int c1, int c2) // ok
  {
    if(mode == Mode.OPERATION) return Response.ILLEGAL_OPERATION;
  ...
  public Response enterAdminMode(long code) // ok
  {
  ...
  public Response setPrices(int p1, int p2) // ok
  {
    if(mode == Mode.OPERATION) return Response.ILLEGAL_OPERATION;
  ...
  public Response returnMoney()
  {
    ...
    else if(balance > coins1*coinval1 + coins2*coinval2) return Response.TOO_BIG_CHANGE;

    else if(balance > coins2*coinval2) // 4 first  12 second  8
    {
      // using coinval1 == 1
    ...
    else if(coins1 == 0) return Response.UNSUITABLE_CHANGE;
    else
    {
      // using coinval1 == 1
      coins2 -= (balance/coinval2);
  ...
  public Response giveProduct1(int number)
  {
    ...
    else if(res > coins1*coinval1 + coins2*coinval2) return Response.TOO_BIG_CHANGE;
